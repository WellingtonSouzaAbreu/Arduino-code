...
const char* ssid = "Dumb"; // Nome da rede
const char* password = "pipocadoce"; // Senha da rede
const char* websockets_server_host = "192.168.2.183"; // IP do servidor websocket
const int websockets_server_port = 1000; // Porta de conexão do servidor
